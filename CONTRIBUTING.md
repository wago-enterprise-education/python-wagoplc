...
This module uses [uv](https://uv.pypa.io/en/stable/) as the build system. To set up the development environment, execute the following command in your favourite terminal emulator:
