...
| `generate-lazydocs.yml` | Generate API docs from docstrings and commit updates | Push to non-main (`src/**`, `pyproject.toml`, workflow file) or manual | [generate-lazydocs.md](generate-lazydocs.md) |
