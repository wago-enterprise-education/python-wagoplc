...
CI execution details, including the current Python version matrix, are documented in [run-tests.md](https://github.com/wago-enterprise-education/python-wagoplc/blob/main/.github/workflows/run-tests.md).
