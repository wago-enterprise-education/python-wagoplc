...
- [variables_external.py](variables_external.py): Variable-based task where I/O and variable mapping come from external configuration.
...
The script-based examples show two common ways to structure an application: keep I/O bindings in Python for quicker prototyping, or move configuration into YAML when the deployment layout should be generated or maintained separately.
...
For this project, the preferred direction is variable-based design with script-first behavior and optional external configuration.
